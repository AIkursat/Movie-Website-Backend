...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "dsn", "postgres://postgres:0123321@localhost/go_movies?sslmode=disable", "Postgres connection string")
	...
	defer db.Close() // When you open it, you always have to close it too!!!
